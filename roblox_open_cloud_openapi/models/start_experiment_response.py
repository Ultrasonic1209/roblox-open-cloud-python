...
T = TypeVar("T", bound="StartExperimentResponse")
...
class StartExperimentResponse:
    ...
    `POST /v1/experimentation/universes/{universeId}/experiments/{experimentId}:start`.
        ...
        Attributes:
            operation (ExperimentOperation | None | Unset): The async operation that started the experiment.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_experiment_response = cls(
            operation=operation,
        )

        return start_experiment_response
