...
T = TypeVar("T", bound="RobloxGroupsApiCreateWallPostRequest")


@_attrs_define
class RobloxGroupsApiCreateWallPostRequest:
    """A request model for creating a group wall post

    Attributes:
        body (str | Unset): The wall post body
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_groups_api_create_wall_post_request = cls(
            body=body,
        ...
        return roblox_groups_api_create_wall_post_request
