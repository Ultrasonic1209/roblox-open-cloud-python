...
T = TypeVar("T", bound="ProblemDetailsType0")


@_attrs_define
class ProblemDetailsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        problem_details_type_0.additional_properties = d
        return problem_details_type_0
