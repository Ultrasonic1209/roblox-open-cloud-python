...
T = TypeVar("T", bound="UpdateGameEventConfigRequest")


@_attrs_define
class UpdateGameEventConfigRequest:
    """Optional config block on the v3 PATCH body. Null sub-fields = no change.

    Attributes:
        recurrence (None | str | Unset): New cron recurrence expression. Null = no change. Validated server-side.
