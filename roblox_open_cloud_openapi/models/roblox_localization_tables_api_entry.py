...
T = TypeVar("T", bound="RobloxLocalizationTablesApiEntry")


@_attrs_define
class RobloxLocalizationTablesApiEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_localization_tables_api_entry = cls(
        ...
        return roblox_localization_tables_api_entry
