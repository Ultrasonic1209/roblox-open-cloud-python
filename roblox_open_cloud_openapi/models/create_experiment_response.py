...
class CreateExperimentResponse:
    """Response body for POST /v1/universes/{universeId}/experiment.

    Attributes:
        operation (ExperimentOperation | None | Unset): Resulting async operation describing the create call.
    """
