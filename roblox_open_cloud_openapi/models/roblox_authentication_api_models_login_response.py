...
class RobloxAuthenticationApiModelsLoginResponse:
    ...
    Attributes:
        ...
        should_prompt_credential_invalidation (bool | Unset):
    """
    ...
    should_prompt_credential_invalidation: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        should_prompt_credential_invalidation = self.should_prompt_credential_invalidation
        ...
        if should_prompt_credential_invalidation is not UNSET:
            field_dict["shouldPromptCredentialInvalidation"] = should_prompt_credential_invalidation
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        should_prompt_credential_invalidation = d.pop("shouldPromptCredentialInvalidation", UNSET)
        ...
        roblox_authentication_api_models_login_response = cls(
            ...
            should_prompt_credential_invalidation=should_prompt_credential_invalidation,
        )
