...
T = TypeVar("T", bound="GetExperimentOperationStatusResponse")


@_attrs_define
class GetExperimentOperationStatusResponse:
    """Response body for
    `GET /v1/experimentation/universes/{universeId}/operations/{operationId}`.

        Attributes:
            operation (ExperimentOperation | None | Unset): The current state of the async operation.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_experiment_operation_status_response = cls(
            operation=operation,
        )

        return get_experiment_operation_status_response
