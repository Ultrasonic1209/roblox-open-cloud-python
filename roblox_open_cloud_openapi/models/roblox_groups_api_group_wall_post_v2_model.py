...
T = TypeVar("T", bound="RobloxGroupsApiGroupWallPostV2Model")


@_attrs_define
class RobloxGroupsApiGroupWallPostV2Model:
    """A response model for group wall post information

    Attributes:
        id (int | Unset): The group wall post Id.
        poster (RobloxGroupsApiUserGroupRoleResponse | Unset): A user group role response model
    ...
    id: int | Unset = UNSET
    poster: RobloxGroupsApiUserGroupRoleResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        poster: RobloxGroupsApiUserGroupRoleResponse | Unset
        if isinstance(_poster, Unset):
            poster = UNSET
        else:
            poster = RobloxGroupsApiUserGroupRoleResponse.from_dict(_poster)
        ...
        roblox_groups_api_group_wall_post_v2_model = cls(
            id=id,
            poster=poster,
            body=body,
            created=created,
        ...
        return roblox_groups_api_group_wall_post_v2_model
