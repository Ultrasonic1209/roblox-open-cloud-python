...
from ..models.roblox_api_avatar_models_v4_update_avatar_model_v4_player_avatar_type import (
...
T = TypeVar("T", bound="RobloxApiAvatarModelsV4UpdateAvatarModelV4")


@_attrs_define
class RobloxApiAvatarModelsV4UpdateAvatarModelV4:
    """A model containing avatar model fields to update.

    Attributes:
        scales (RobloxWebResponsesAvatarScaleModel | Unset):
        player_avatar_type (RobloxApiAvatarModelsV4UpdateAvatarModelV4PlayerAvatarType | Unset): The avatar type.
    ...
    player_avatar_type: RobloxApiAvatarModelsV4UpdateAvatarModelV4PlayerAvatarType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        player_avatar_type: RobloxApiAvatarModelsV4UpdateAvatarModelV4PlayerAvatarType | Unset
        if isinstance(_player_avatar_type, Unset):
            player_avatar_type = UNSET
        else:
            player_avatar_type = RobloxApiAvatarModelsV4UpdateAvatarModelV4PlayerAvatarType(_player_avatar_type)
        ...
        roblox_api_avatar_models_v4_update_avatar_model_v4 = cls(
            scales=scales,
        ...
        return roblox_api_avatar_models_v4_update_avatar_model_v4
