...
T = TypeVar("T", bound="RobloxCatalogApiBundleItemDetailModel")


@_attrs_define
class RobloxCatalogApiBundleItemDetailModel:
    """
    Attributes:
        owned (bool | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_catalog_api_bundle_item_detail_model = cls(
            owned=owned,
            id=id,
            name=name,
            type_=type_,
        ...
        return roblox_catalog_api_bundle_item_detail_model
