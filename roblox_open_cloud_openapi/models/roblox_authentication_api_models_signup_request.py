...
from ..models.roblox_authentication_api_models_signup_request_signup_type import (
    RobloxAuthenticationApiModelsSignupRequestSignupType,
)
...
class RobloxAuthenticationApiModelsSignupRequest:
    ...
    Attributes:
        ...
        signup_type (RobloxAuthenticationApiModelsSignupRequestSignupType | Unset):  ['Regular' = 0, 'Express' = 1]
        email (str | Unset):
        locale (str | Unset):
    ...
    signup_type: RobloxAuthenticationApiModelsSignupRequestSignupType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        signup_type: int | Unset = UNSET
        if not isinstance(self.signup_type, Unset):
            signup_type = self.signup_type.value
        ...
        if signup_type is not UNSET:
            field_dict["signupType"] = signup_type
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _signup_type = d.pop("signupType", UNSET)
        signup_type: RobloxAuthenticationApiModelsSignupRequestSignupType | Unset
        if isinstance(_signup_type, Unset):
            signup_type = UNSET
        else:
            signup_type = RobloxAuthenticationApiModelsSignupRequestSignupType(_signup_type)
