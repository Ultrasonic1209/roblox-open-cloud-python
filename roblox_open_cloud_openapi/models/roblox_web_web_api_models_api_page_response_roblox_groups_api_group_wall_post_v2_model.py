...
T = TypeVar("T", bound="RobloxWebWebAPIModelsApiPageResponseRobloxGroupsApiGroupWallPostV2Model")


@_attrs_define
class RobloxWebWebAPIModelsApiPageResponseRobloxGroupsApiGroupWallPostV2Model:
    """
    Attributes:
        previous_page_cursor (str | Unset):
        next_page_cursor (str | Unset):
        data (list[RobloxGroupsApiGroupWallPostV2Model] | Unset):
    """

    previous_page_cursor: str | Unset = UNSET
    next_page_cursor: str | Unset = UNSET
    data: list[RobloxGroupsApiGroupWallPostV2Model] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RobloxGroupsApiGroupWallPostV2Model.from_dict(data_item_data)

                data.append(data_item)

        roblox_web_web_api_models_api_page_response_roblox_groups_api_group_wall_post_v2_model = cls(
            previous_page_cursor=previous_page_cursor,
            next_page_cursor=next_page_cursor,
            data=data,
        )

        return roblox_web_web_api_models_api_page_response_roblox_groups_api_group_wall_post_v2_model
