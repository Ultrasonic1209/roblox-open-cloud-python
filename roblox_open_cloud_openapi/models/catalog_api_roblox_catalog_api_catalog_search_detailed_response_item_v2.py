...
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_asset_type import (
    CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2AssetType,
)
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_bundle_type import (
    CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2BundleType,
)
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_creator_type import (
    CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2CreatorType,
)
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_item_restrictions_item import (
    CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemRestrictionsItem,
)
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_item_status_item import (
    CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemStatusItem,
)
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_item_type import (
    CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemType,
)
from ..models.catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2_sale_location_type import (
...
T = TypeVar("T", bound="CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2")


@_attrs_define
class CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2:
    ...
    Attributes:
        ...
        item_type (CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemType | Unset): The
            Roblox.Catalog.Api.CatalogSearchDetailedResponseItem.ItemType item type. ['Asset' = 1, 'Bundle' = 2]
        asset_type (CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2AssetType | Unset): The
            Roblox.Platform.Assets.AssetType serialized if item is an asset.
        bundle_type (CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2BundleType | Unset): The
        ...
        item_status (list[CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemStatusItem] | Unset): The
            System.Collections.Generic.IEnumerable`1 if item has Roblox.Catalog.Api.CatalogItemStatus.
        item_restrictions (list[CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemRestrictionsItem] |
            Unset): The System.Collections.Generic.IEnumerable`1 if item has Roblox.Catalog.Api.CatalogItemRestriction.
        creator_has_verified_badge (bool | Unset): The verified status of a creator.
        creator_type (CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2CreatorType | Unset): The
        ...
        sale_location_type (CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2SaleLocationType | Unset): The
            sale location type of the item. ['NotApplicable' = 0, 'ShopOnly' = 1, 'MyExperiencesOnly' = 2,
            'ShopAndMyExperiences' = 3, 'ExperiencesById' = 4, 'ShopAndAllExperiences' = 5, 'ExperiencesDevApiOnly' = 6,
    ...
    id: int | Unset = UNSET
    item_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemType | Unset = UNSET
    asset_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2AssetType | Unset = UNSET
    bundle_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2BundleType | Unset = UNSET
    is_recolorable: bool | Unset = UNSET
    name: str | Unset = UNSET
    description: str | Unset = UNSET
    product_id: int | Unset = UNSET
    item_status: list[CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemStatusItem] | Unset = UNSET
    item_restrictions: (
        list[CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemRestrictionsItem] | Unset
    ) = UNSET
    creator_has_verified_badge: bool | Unset = UNSET
    creator_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2CreatorType | Unset = UNSET
    ...
    sale_location_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2SaleLocationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemType | Unset
        if isinstance(_item_type, Unset):
            item_type = UNSET
        else:
            item_type = CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemType(_item_type)

        _asset_type = d.pop("assetType", UNSET)
        asset_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2AssetType | Unset
        if isinstance(_asset_type, Unset):
            asset_type = UNSET
        else:
            asset_type = CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2AssetType(_asset_type)

        _bundle_type = d.pop("bundleType", UNSET)
        bundle_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2BundleType | Unset
        if isinstance(_bundle_type, Unset):
            bundle_type = UNSET
        else:
            bundle_type = CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2BundleType(_bundle_type)
        ...
        if _item_status is not UNSET:
            ...
            for item_status_item_data in _item_status:
                item_status_item = CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2ItemStatusItem(
        ...
        creator_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2CreatorType | Unset
        if isinstance(_creator_type, Unset):
            creator_type = UNSET
        else:
            creator_type = CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2CreatorType(_creator_type)
        ...
        sale_location_type: CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2SaleLocationType | Unset
        if isinstance(_sale_location_type, Unset):
            sale_location_type = UNSET
        else:
            sale_location_type = CatalogApiRobloxCatalogApiCatalogSearchDetailedResponseItemV2SaleLocationType(
                _sale_location_type
            )
        ...
        catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2 = cls(
        ...
        return catalog_api_roblox_catalog_api_catalog_search_detailed_response_item_v2
