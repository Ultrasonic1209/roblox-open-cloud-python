...
T = TypeVar("T", bound="RobloxTwoStepVerificationApiEnableTwoStepVerificationRequest")


@_attrs_define
class RobloxTwoStepVerificationApiEnableTwoStepVerificationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_two_step_verification_api_enable_two_step_verification_request = cls(
            password=password,
            secure_authentication_intent=secure_authentication_intent,
        )

        return roblox_two_step_verification_api_enable_two_step_verification_request
