...
T = TypeVar("T", bound="ServerManagementServiceProblemDetails")


@_attrs_define
class ServerManagementServiceProblemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_management_service_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        server_management_service_problem_details.additional_properties = d
        return server_management_service_problem_details
