...
T = TypeVar("T", bound="CreateMatchmakingScoringConfigurationRequestMatchmakingSignalWeightsType0")


@_attrs_define
class CreateMatchmakingScoringConfigurationRequestMatchmakingSignalWeightsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_matchmaking_scoring_configuration_request_matchmaking_signal_weights_type_0 = cls(
            invalid=invalid,
            occupancy=occupancy,
            age=age,
            language=language,
        ...
        return create_matchmaking_scoring_configuration_request_matchmaking_signal_weights_type_0
