...
T = TypeVar("T", bound="UpdateDraftRequestEntriesType0")


@_attrs_define
class UpdateDraftRequestEntriesType0:
    """On PATCH, keys not included are unchanged; set a key to null to delete a branch or entry per merge rules.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return update_draft_request_entries_type_0
