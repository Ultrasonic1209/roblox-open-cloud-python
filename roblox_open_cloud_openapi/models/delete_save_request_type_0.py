...
T = TypeVar("T", bound="DeleteSaveRequestType0")


@_attrs_define
class DeleteSaveRequestType0:
    """Request model for deleting a save
    ...
    Attributes:
        ...
        target_id (int): The ID of the asset being deleted
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_save_request_type_0 = cls(
            target_type=target_type,
            target_id=target_id,
            collection_name=collection_name,
        )

        return delete_save_request_type_0
