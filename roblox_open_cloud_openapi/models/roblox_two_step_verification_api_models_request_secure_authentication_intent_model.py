...
T = TypeVar("T", bound="RobloxTwoStepVerificationApiModelsRequestSecureAuthenticationIntentModel")


@_attrs_define
class RobloxTwoStepVerificationApiModelsRequestSecureAuthenticationIntentModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_two_step_verification_api_models_request_secure_authentication_intent_model = cls(
        ...
        return roblox_two_step_verification_api_models_request_secure_authentication_intent_model
