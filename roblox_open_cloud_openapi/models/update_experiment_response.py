...
T = TypeVar("T", bound="UpdateExperimentResponse")


@_attrs_define
class UpdateExperimentResponse:
    """Response body for PATCH /v1/universes/{universeId}/experiment/{experimentId}.

    Attributes:
        operation (ExperimentOperation | None | Unset): Resulting async operation describing the update call.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_experiment_response = cls(
            operation=operation,
        )

        return update_experiment_response
