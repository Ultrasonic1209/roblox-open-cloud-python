...
T = TypeVar("T", bound="GetMatchmakingScoringDefaultWeightsResponseWeightsType0")


@_attrs_define
class GetMatchmakingScoringDefaultWeightsResponseWeightsType0:
    """The weights of the current default matchmaking scoring weights.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_matchmaking_scoring_default_weights_response_weights_type_0 = cls(
            invalid=invalid,
            occupancy=occupancy,
            age=age,
            language=language,
        ...
        return get_matchmaking_scoring_default_weights_response_weights_type_0
