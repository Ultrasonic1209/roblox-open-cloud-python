...
T = TypeVar("T", bound="ShutdownGameInstancesResponse")


@_attrs_define
class ShutdownGameInstancesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shutdown_game_instances_response = cls(
            place_id=place_id,
            private_server_id=private_server_id,
            game_id=game_id,
        )

        return shutdown_game_instances_response
