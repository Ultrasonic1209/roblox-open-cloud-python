...
T = TypeVar("T", bound="UpdateCustomMatchmakingSignalRequest")


@_attrs_define
class UpdateCustomMatchmakingSignalRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_custom_matchmaking_signal_request = cls(
            scoring_configuration_id=scoring_configuration_id,
            signal_configuration=signal_configuration,
        )

        return update_custom_matchmaking_signal_request
