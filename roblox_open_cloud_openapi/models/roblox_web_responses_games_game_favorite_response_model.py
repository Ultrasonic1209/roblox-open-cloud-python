...
T = TypeVar("T", bound="RobloxWebResponsesGamesGameFavoriteResponseModel")


@_attrs_define
class RobloxWebResponsesGamesGameFavoriteResponseModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return roblox_web_responses_games_game_favorite_response_model
