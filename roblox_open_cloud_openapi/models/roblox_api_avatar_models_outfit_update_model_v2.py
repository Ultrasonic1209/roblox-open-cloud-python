...
from ..models.roblox_api_avatar_models_outfit_update_model_v2_outfit_type import (
...
T = TypeVar("T", bound="RobloxApiAvatarModelsOutfitUpdateModelV2")


@_attrs_define
class RobloxApiAvatarModelsOutfitUpdateModelV2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        outfit_type: RobloxApiAvatarModelsOutfitUpdateModelV2OutfitType | Unset
        if isinstance(_outfit_type, Unset):
            outfit_type = UNSET
        else:
            outfit_type = RobloxApiAvatarModelsOutfitUpdateModelV2OutfitType(_outfit_type)

        roblox_api_avatar_models_outfit_update_model_v2 = cls(
            name=name,
        ...
        return roblox_api_avatar_models_outfit_update_model_v2
