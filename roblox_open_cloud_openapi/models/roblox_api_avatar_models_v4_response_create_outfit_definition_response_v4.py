...
T = TypeVar("T", bound="RobloxApiAvatarModelsV4ResponseCreateOutfitDefinitionResponseV4")


@_attrs_define
class RobloxApiAvatarModelsV4ResponseCreateOutfitDefinitionResponseV4:
    """Response model for create outfit (V4).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_api_avatar_models_v4_response_create_outfit_definition_response_v4 = cls(
            success=success,
            validation=validation,
        )

        return roblox_api_avatar_models_v4_response_create_outfit_definition_response_v4
