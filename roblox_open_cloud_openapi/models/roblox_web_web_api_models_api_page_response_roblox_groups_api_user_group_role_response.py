...
T = TypeVar("T", bound="RobloxWebWebAPIModelsApiPageResponseRobloxGroupsApiUserGroupRoleResponse")


@_attrs_define
class RobloxWebWebAPIModelsApiPageResponseRobloxGroupsApiUserGroupRoleResponse:
    """
    Attributes:
        previous_page_cursor (str | Unset):
        next_page_cursor (str | Unset):
        data (list[RobloxGroupsApiUserGroupRoleResponse] | Unset):
    """

    previous_page_cursor: str | Unset = UNSET
    next_page_cursor: str | Unset = UNSET
    data: list[RobloxGroupsApiUserGroupRoleResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RobloxGroupsApiUserGroupRoleResponse.from_dict(data_item_data)

                data.append(data_item)

        roblox_web_web_api_models_api_page_response_roblox_groups_api_user_group_role_response = cls(
            previous_page_cursor=previous_page_cursor,
            next_page_cursor=next_page_cursor,
            data=data,
        )

        return roblox_web_web_api_models_api_page_response_roblox_groups_api_user_group_role_response
