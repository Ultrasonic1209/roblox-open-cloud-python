...
T = TypeVar("T", bound="RobloxWebWebAPIModelsApiPageResponseRobloxCatalogApiBundleDetailsModel")


@_attrs_define
class RobloxWebWebAPIModelsApiPageResponseRobloxCatalogApiBundleDetailsModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_web_web_api_models_api_page_response_roblox_catalog_api_bundle_details_model = cls(
            previous_page_cursor=previous_page_cursor,
            next_page_cursor=next_page_cursor,
            data=data,
        )

        return roblox_web_web_api_models_api_page_response_roblox_catalog_api_bundle_details_model
