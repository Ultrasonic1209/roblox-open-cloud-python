...
T = TypeVar("T", bound="SetMatchmakingScoringConfigurationResponse")


@_attrs_define
class SetMatchmakingScoringConfigurationResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_matchmaking_scoring_configuration_response = cls(
            scoring_configuration=scoring_configuration,
        )

        return set_matchmaking_scoring_configuration_response
