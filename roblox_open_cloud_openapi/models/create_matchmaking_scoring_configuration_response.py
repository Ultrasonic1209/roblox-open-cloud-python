...
T = TypeVar("T", bound="CreateMatchmakingScoringConfigurationResponse")


@_attrs_define
class CreateMatchmakingScoringConfigurationResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_matchmaking_scoring_configuration_response = cls(
            scoring_configuration=scoring_configuration,
        )

        return create_matchmaking_scoring_configuration_response
