...
T = TypeVar("T", bound="TransactionRecordResponse")
...
class TransactionRecordResponse:
    ...
    Attributes:
        ...
        transaction_subtype (None | str | Unset):
        o_18_eligibility_tag (None | O18EligibilityTag | Unset):
        robux_rate_breakdown (None | RobuxRateBreakdown | Unset):
    """
    ...
    transaction_subtype: None | str | Unset = UNSET
    o_18_eligibility_tag: None | O18EligibilityTag | Unset = UNSET
    robux_rate_breakdown: None | RobuxRateBreakdown | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        transaction_subtype: None | str | Unset
        if isinstance(self.transaction_subtype, Unset):
            transaction_subtype = UNSET
        else:
        ...
        robux_rate_breakdown: dict[str, Any] | None | Unset
        if isinstance(self.robux_rate_breakdown, Unset):
            robux_rate_breakdown = UNSET
        elif isinstance(self.robux_rate_breakdown, RobuxRateBreakdown):
            robux_rate_breakdown = self.robux_rate_breakdown.to_dict()
        else:
            robux_rate_breakdown = self.robux_rate_breakdown
        ...
        if transaction_subtype is not UNSET:
            field_dict["transactionSubtype"] = transaction_subtype
        if o_18_eligibility_tag is not UNSET:
            field_dict["o18EligibilityTag"] = o_18_eligibility_tag
        if robux_rate_breakdown is not UNSET:
            field_dict["robuxRateBreakdown"] = robux_rate_breakdown
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_transaction_type(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        transaction_type = _parse_transaction_type(d.pop("transactionType", UNSET))
        ...
        def _parse_transaction_subtype(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        transaction_subtype = _parse_transaction_subtype(d.pop("transactionSubtype", UNSET))
        ...
        def _parse_robux_rate_breakdown(data: object) -> None | RobuxRateBreakdown | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                robux_rate_breakdown_type_1 = RobuxRateBreakdown.from_dict(data)

                return robux_rate_breakdown_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RobuxRateBreakdown | Unset, data)

        robux_rate_breakdown = _parse_robux_rate_breakdown(d.pop("robuxRateBreakdown", UNSET))

        transaction_record_response = cls(
            id=id,
            id_hash=id_hash,
            ...
            robux_rate_breakdown=robux_rate_breakdown,
        )

        return transaction_record_response
