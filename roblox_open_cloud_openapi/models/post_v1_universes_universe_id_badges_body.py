...
from .. import types
from ..models.post_v1_universes_universe_id_badges_body_payment_source_type import (
    PostV1UniversesUniverseIdBadgesBodyPaymentSourceType,
)
from ..types import UNSET, File, FileTypes, Unset

T = TypeVar("T", bound="PostV1UniversesUniverseIdBadgesBody")


@_attrs_define
class PostV1UniversesUniverseIdBadgesBody:
    """
    Attributes:
    ...
    payment_source_type: PostV1UniversesUniverseIdBadgesBodyPaymentSourceType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_source_type: PostV1UniversesUniverseIdBadgesBodyPaymentSourceType | Unset
        if isinstance(_payment_source_type, Unset):
            payment_source_type = UNSET
        else:
            payment_source_type = PostV1UniversesUniverseIdBadgesBodyPaymentSourceType(_payment_source_type)
        ...
        post_v1_universes_universe_id_badges_body = cls(
            name=name,
        ...
        post_v1_universes_universe_id_badges_body.additional_properties = d
        return post_v1_universes_universe_id_badges_body
