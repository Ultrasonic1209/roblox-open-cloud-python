...
from ..models.roblox_item_configuration_api_models_request_publishing_preferences_update_publishing_preferences_request_publishing_type import (
    RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequestPublishingType,
)
from ..models.roblox_item_configuration_api_models_request_publishing_preferences_update_publishing_preferences_request_sale_location_type import (
    RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequestSaleLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequest")


@_attrs_define
class RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_publishing_type, Unset):
            ...
            publishing_type = RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequestPublishingType(
                _publishing_type
            )
        ...
        if isinstance(_sale_location_type, Unset):
            ...
            sale_location_type = RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequestSaleLocationType(
                _sale_location_type
            )
        ...
        roblox_item_configuration_api_models_request_publishing_preferences_update_publishing_preferences_request = cls(
        ...
        return roblox_item_configuration_api_models_request_publishing_preferences_update_publishing_preferences_request
