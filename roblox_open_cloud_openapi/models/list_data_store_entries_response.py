...
T = TypeVar("T", bound="ListDataStoreEntriesResponse")


@_attrs_define
class ListDataStoreEntriesResponse:
    """A list of DataStoreEntries in the parent collection.

    Attributes:
        data_store_entries (list[DataStoreEntry] | Unset): The DataStoreEntries from the specified DataStore or
            DataStoreScope.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_data_store_entries_response = cls(
            data_store_entries=data_store_entries,
            next_page_token=next_page_token,
        )

        list_data_store_entries_response.additional_properties = d
        return list_data_store_entries_response
