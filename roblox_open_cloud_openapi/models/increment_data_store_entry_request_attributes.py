...
T = TypeVar("T", bound="IncrementDataStoreEntryRequestAttributes")


@_attrs_define
class IncrementDataStoreEntryRequestAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return increment_data_store_entry_request_attributes
