...
T = TypeVar("T", bound="DeleteCustomMatchmakingSignalResponse")


@_attrs_define
class DeleteCustomMatchmakingSignalResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_custom_matchmaking_signal_response = cls(
            scoring_configuration=scoring_configuration,
        )

        return delete_custom_matchmaking_signal_response
