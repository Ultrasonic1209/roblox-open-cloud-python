...
T = TypeVar("T", bound="RobloxWebResponsesGamesGameResponseV2")


@_attrs_define
class RobloxWebResponsesGamesGameResponseV2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_web_responses_games_game_response_v2 = cls(
            id=id,
            name=name,
        ...
        return roblox_web_responses_games_game_response_v2
