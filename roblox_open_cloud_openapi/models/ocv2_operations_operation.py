...
T = TypeVar("T", bound="OCV2OperationsOperation")


@_attrs_define
class OCV2OperationsOperation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ocv2_operations_operation.additional_properties = d
        return ocv2_operations_operation
