...
T = TypeVar("T", bound="RobloxGroupsApiGroupSearchPageResponse")


@_attrs_define
class RobloxGroupsApiGroupSearchPageResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RobloxGroupsApiGroupSearchResponseItem.from_dict(data_item_data)
        ...
        return roblox_groups_api_group_search_page_response
