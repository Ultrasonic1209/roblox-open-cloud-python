...
T = TypeVar("T", bound="RobloxPlatformUniverseSettingsUniverseAvatarAssetOverrideResponseModel")


@_attrs_define
class RobloxPlatformUniverseSettingsUniverseAvatarAssetOverrideResponseModel:
    """
    Attributes:
        asset_id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_platform_universe_settings_universe_avatar_asset_override_response_model = cls(
            asset_id=asset_id,
            asset_type_id=asset_type_id,
            is_player_choice=is_player_choice,
        )

        return roblox_platform_universe_settings_universe_avatar_asset_override_response_model
