...
T = TypeVar("T", bound="RobloxGamesApiModelsResponseVerifiedBadgeUserResponse")


@_attrs_define
class RobloxGamesApiModelsResponseVerifiedBadgeUserResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_games_api_models_response_verified_badge_user_response = cls(
        ...
        return roblox_games_api_models_response_verified_badge_user_response
