...
T = TypeVar("T", bound="RobloxApiAvatarModelsAvatarRulesModelAccessoryRefinementLowerBounds")


@_attrs_define
class RobloxApiAvatarModelsAvatarRulesModelAccessoryRefinementLowerBounds:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_api_avatar_models_avatar_rules_model_accessory_refinement_lower_bounds = cls()
        ...
        roblox_api_avatar_models_avatar_rules_model_accessory_refinement_lower_bounds.additional_properties = (
            additional_properties
        )
        return roblox_api_avatar_models_avatar_rules_model_accessory_refinement_lower_bounds
