...
T = TypeVar("T", bound="CreateCustomMatchmakingSignalResponse")


@_attrs_define
class CreateCustomMatchmakingSignalResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_custom_matchmaking_signal_response = cls(
            scoring_configuration=scoring_configuration,
        )

        return create_custom_matchmaking_signal_response
