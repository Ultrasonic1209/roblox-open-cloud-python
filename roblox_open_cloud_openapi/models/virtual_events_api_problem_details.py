...
T = TypeVar("T", bound="VirtualEventsApiProblemDetails")


@_attrs_define
class VirtualEventsApiProblemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virtual_events_api_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        virtual_events_api_problem_details.additional_properties = d
        return virtual_events_api_problem_details
