...
class RobloxWebWebAPIModelsApiArrayResponseRobloxGroupsApiGroupDetailResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_web_web_api_models_api_array_response_roblox_groups_api_group_detail_response = cls(
            data=data,
        )

        return roblox_web_web_api_models_api_array_response_roblox_groups_api_group_detail_response
