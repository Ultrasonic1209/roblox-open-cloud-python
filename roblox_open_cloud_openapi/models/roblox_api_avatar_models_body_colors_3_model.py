...
T = TypeVar("T", bound="RobloxApiAvatarModelsBodyColors3Model")


@_attrs_define
class RobloxApiAvatarModelsBodyColors3Model:
    """A model containing RGB hex colors for each body part.

    Attributes:
        head_color_3 (str | Unset): The RGB hex color for head color, e.g. #FFFFFF
        torso_color_3 (str | Unset): The RGB hex color for torso color, e.g. #FFFFFF
        right_arm_color_3 (str | Unset): The RGB hex color for right arm color, e.g. #FFFFFF
        left_arm_color_3 (str | Unset): The RGB hex color for left arm color, e.g. #FFFFFF
        right_leg_color_3 (str | Unset): The RGB hex color for right leg color, e.g. #FFFFFF
        left_leg_color_3 (str | Unset): The RGB hex color for left leg color, e.g. #FFFFFF
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_api_avatar_models_body_colors_3_model = cls(
        ...
        return roblox_api_avatar_models_body_colors_3_model
