...
T = TypeVar("T", bound="TransactionResponseApiPageResponse")


@_attrs_define
class TransactionResponseApiPageResponse:
    """
    Attributes:
        previous_page_cursor (None | str | Unset):
        next_page_cursor (None | str | Unset):
        data (list[TransactionResponse] | None | Unset):
    """

    previous_page_cursor: None | str | Unset = UNSET
    next_page_cursor: None | str | Unset = UNSET
    data: list[TransactionResponse] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[TransactionResponse] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = TransactionResponse.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[TransactionResponse] | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        transaction_response_api_page_response = cls(
            previous_page_cursor=previous_page_cursor,
            next_page_cursor=next_page_cursor,
            data=data,
        )

        return transaction_response_api_page_response
