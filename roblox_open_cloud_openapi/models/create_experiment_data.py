...
T = TypeVar("T", bound="CreateExperimentData")


@_attrs_define
class CreateExperimentData:
    """Request body for `POST /v1/experimentation/universes/{universeId}/experiments`.
