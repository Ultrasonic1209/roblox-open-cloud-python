...
T = TypeVar("T", bound="RobloxUsersApiBirthdateResponse")


@_attrs_define
class RobloxUsersApiBirthdateResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_users_api_birthdate_response = cls(
            birth_month=birth_month,
            birth_day=birth_day,
            birth_year=birth_year,
        )

        return roblox_users_api_birthdate_response
