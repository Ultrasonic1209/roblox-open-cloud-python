...
T = TypeVar("T", bound="RobloxGameInternationalizationApiAutoLocalizationMetadataResponse")


@_attrs_define
class RobloxGameInternationalizationApiAutoLocalizationMetadataResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roblox_game_internationalization_api_auto_localization_metadata_response = cls(
        ...
        return roblox_game_internationalization_api_auto_localization_metadata_response
