...
class ThumbnailPersonalizationApiHomepageThumbnailUploadHomepageThumbnailsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        thumbnail_personalization_api_homepage_thumbnail_upload_homepage_thumbnails_body.additional_properties = d
        return thumbnail_personalization_api_homepage_thumbnail_upload_homepage_thumbnails_body
