...
T = TypeVar("T", bound="DiscardExperimentResponse")


@_attrs_define
class DiscardExperimentResponse:
    """Response body for DELETE /v1/universes/{universeId}/experiment/{experimentId}.

    Attributes:
        operation (ExperimentOperation | None | Unset): Resulting async operation describing the delete call.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discard_experiment_response = cls(
            operation=operation,
        )

        return discard_experiment_response
