...
def _get_kwargs(
    badge_id: int,
    *,
    body: PostLegacyPublishV1BadgesBadgeIdIconBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/legacy-publish/v1/badges/{badge_id}/icon".format(
        ...
        "openapi-id": "post_legacy-publish_v1_badges_badgeId_icon",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        badge_id (int):
        body (PostLegacyPublishV1BadgesBadgeIdIconBody | Unset):
