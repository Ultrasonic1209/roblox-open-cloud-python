...
from ...models.roblox_item_configuration_api_models_request_publishing_preferences_update_publishing_preferences_request import (
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "patch_v1_preferences_publishing",
        },
    }

    if isinstance(body, RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferencesRequest):
...
def sync_detailed(
    *,
    ...
    """
    Args:
        body (RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferen
            cesRequest):
        body (RobloxItemConfigurationApiModelsRequestPublishingPreferencesUpdatePublishingPreferen
            cesRequest):
