...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "https://assetdelivery.roblox.com/v1/assetId/{asset_id}".format(
        ...
        "extensions": {
            ...
            "openapi-id": "get_v1_assetId_assetId",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/assets#assetdelivery_get_v1_assetId__assetId_"
)
def sync_detailed(
    asset_id: int,
    *,
