...
from ...models.post_v1_plugins_plugin_id_icon_body import PostV1PluginsPluginIdIconBody
...
def _get_kwargs(
    plugin_id: int,
    *,
    body: PostV1PluginsPluginIdIconBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        plugin_id (int):
        body (PostV1PluginsPluginIdIconBody | Unset):
