...
from ...models.roblox_api_notifications_models_register_android_request_model import (
...
def _get_kwargs(
    *,
    body: RobloxApiNotificationsModelsRegisterAndroidRequestModel
    | RobloxApiNotificationsModelsRegisterAndroidRequestModel
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "post_v2_push-notifications_register-android-native",
        },
    }

    if isinstance(body, RobloxApiNotificationsModelsRegisterAndroidRequestModel):
