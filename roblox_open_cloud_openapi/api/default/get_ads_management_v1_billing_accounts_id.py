...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ads-management/v1/billing-accounts/{id}".format(
        ...
        "extensions": {
            ...
            "openapi-id": "get_ads-management_v1_billing-accounts_id",
        },
    }
...
) -> InternalPublicV1BillingAccount | InternalPublicV1ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = InternalPublicV1BillingAccount.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
) -> Response[InternalPublicV1BillingAccount | InternalPublicV1ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a billing account
     ...
     Returns a single billing account owned by the authenticated user. Returns 404 if the account does
...
def sync(
    ...
    *,
    ...
    Returns:
        InternalPublicV1BillingAccount | InternalPublicV1ErrorEnvelope
    """
