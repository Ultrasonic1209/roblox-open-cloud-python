...
def _get_kwargs(
    universe_id: int,
    *,
    body: UpdateThumbnailPersonalizationRequest
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/thumbnail-personalization-api/v1/universes/{universe_id}/personalization/update".format(
        ...
        "extensions": {
            ...
            "openapi-id": "ThumbnailPersonalizationApi.HomepageThumbnail_UpdateThumbnailPersonalization",
        },
    }
