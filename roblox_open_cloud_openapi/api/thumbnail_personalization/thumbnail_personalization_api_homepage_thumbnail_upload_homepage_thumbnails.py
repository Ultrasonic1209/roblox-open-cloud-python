...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/thumbnail-personalization-api/v1/universes/{universe_id}/thumbnails/uploads".format(
        ...
        "extensions": {
            ...
            "openapi-id": "ThumbnailPersonalizationApi.HomepageThumbnail_UploadHomepageThumbnails",
        },
    }
