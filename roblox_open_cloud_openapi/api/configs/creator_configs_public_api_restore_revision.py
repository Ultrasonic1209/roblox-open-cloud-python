...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/creator-configs-public-api/v1/configs/universes/{universe_id}/repositories/{repository}/revisions/{revision_id}/restore".format(
        ...
        "extensions": {
            ...
            "openapi-id": "CreatorConfigsPublicApi_RestoreRevision",
        },
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Stages a revert to a previous revision.
     ...
     Attempts to restore configs to the provided revision. This will clear the staging and stage a revert
    commit.
