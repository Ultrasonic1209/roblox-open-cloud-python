...
from ...models.config_repository_full import ConfigRepositoryFull
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/creator-configs-public-api/v1/configs/universes/{universe_id}/repositories/{repository}/full".format(
        ...
        "extensions": {
            ...
            "openapi-id": "CreatorConfigsPublicApi_GetConfigRepositoryFull",
        },
    }
...
) -> ActionResult | ConfigRepositoryFull | None:
    if response.status_code == 200:
        response_200 = ConfigRepositoryFull.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
) -> Response[ActionResult | ConfigRepositoryFull]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ActionResult | ConfigRepositoryFull
    """
