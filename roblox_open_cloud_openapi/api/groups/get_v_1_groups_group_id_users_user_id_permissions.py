...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "https://groups.roblox.com/v1/groups/{group_id}/users/{user_id}/permissions".format(
        ...
        "openapi-id": "get_v1_groups_groupId_users_userId_permissions",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/groups#groups_get_v1_groups__groupId__users__userId__permissions"
)
def sync_detailed(
    group_id: int,
    user_id: int,
