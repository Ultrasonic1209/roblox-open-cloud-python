...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "https://groups.roblox.com/v1/groups/{group_id}/relationships/{group_relationship_type}/{related_group_id}".format(
        ...
        "openapi-id": "delete_v1_groups_groupId_relationships_groupRelationshipType_relatedGroupId",
    }
