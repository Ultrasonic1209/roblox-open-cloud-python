...
from ...models.patch_v1_groups_group_id_notification_preference_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "https://groups.roblox.com/v1/groups/{group_id}/notification-preference".format(
        ...
        "extensions": {
            ...
            "openapi-id": "patch_v1_groups_groupId_notification-preference",
        },
    }
...
) -> Any | PatchV1GroupsGroupIdNotificationPreferenceResponse200 | None:
    if response.status_code == 200:
        response_200 = PatchV1GroupsGroupIdNotificationPreferenceResponse200(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
) -> Response[Any | PatchV1GroupsGroupIdNotificationPreferenceResponse200]:
    return Response(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/groups#groups_patch_v1_groups__groupId__notification_preference"
)
def sync_detailed(
    group_id: int,
    *,
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | PatchV1GroupsGroupIdNotificationPreferenceResponse200
    """
