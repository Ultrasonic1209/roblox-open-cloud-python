...
from ...models.roblox_groups_api_update_user_role_request import RobloxGroupsApiUpdateUserRoleRequest
...
def _get_kwargs(
    ...
    user_id: int,
    *,
    body: RobloxGroupsApiUpdateUserRoleRequest | RobloxGroupsApiUpdateUserRoleRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "https://groups.roblox.com/v1/groups/{group_id}/users/{user_id}".format(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/groups#groups_patch_v1_groups__groupId__users__userId_"
)
def sync_detailed(
    group_id: int,
    user_id: int,
    *,
    ...
    Args:
        group_id (int):
        user_id (int):
        body (RobloxGroupsApiUpdateUserRoleRequest): A request model for setting a users role in a
            group.
        body (RobloxGroupsApiUpdateUserRoleRequest): A request model for setting a users role in a
            group.
