...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/groups#groups_delete_v1_groups__groupId__join_requests_users__userId_"
)
def sync_detailed(
    group_id: int,
    user_id: int,
