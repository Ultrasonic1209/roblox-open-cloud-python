...
from ...models.list_group_forum_comments_response import ListGroupForumCommentsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/cloud/v2/groups/{group_id}/forum-categories/{forum_category_id}/posts/{post_id}/comments".format(
        ...
        "openapi-extensions": {
            ...
            "x-roblox-docs": {
                ...
                "resource": {"$ref": "#/components/schemas/GroupForumComment", "name": "GroupForumComment"},
            },
        ...
        "openapi-id": "Cloud_ListGroupForumComments",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
    ...
    if response.status_code == 200:
        response_200 = ListGroupForumCommentsResponse.from_dict(response.json())
