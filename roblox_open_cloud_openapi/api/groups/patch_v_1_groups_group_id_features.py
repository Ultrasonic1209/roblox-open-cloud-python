...
def _get_kwargs(
    group_id: int,
    *,
    body: RobloxGroupsApiSetFeaturesRequestModel | RobloxGroupsApiSetFeaturesRequestModel | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "patch_v1_groups_groupId_features",
        },
    }

    if isinstance(body, RobloxGroupsApiSetFeaturesRequestModel):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        group_id (int):
        body (RobloxGroupsApiSetFeaturesRequestModel): Request model for setting the desired
            status of group features.
        body (RobloxGroupsApiSetFeaturesRequestModel): Request model for setting the desired
            status of group features.
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | RobloxGroupsApiSetFeaturesResponseModel
    """
