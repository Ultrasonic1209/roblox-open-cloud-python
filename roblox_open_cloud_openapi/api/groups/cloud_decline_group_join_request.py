...
from ...models.decline_group_join_request_request import DeclineGroupJoinRequestRequest
...
def _get_kwargs(
    ...
    join_request_id: str,
    *,
    body: DeclineGroupJoinRequestRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/cloud/v2/groups/{group_id}/join-requests/{join_request_id}:decline".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        group_id (str):
        join_request_id (str):
        body (DeclineGroupJoinRequestRequest): A join request ID.
