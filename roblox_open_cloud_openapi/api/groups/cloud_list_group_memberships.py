...
from ...models.list_group_memberships_response import ListGroupMembershipsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/cloud/v2/groups/{group_id}/memberships".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
    ...
    if response.status_code == 200:
        response_200 = ListGroupMembershipsResponse.from_dict(response.json())
