...
from ...models.client_status_set_request import ClientStatusSetRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ClientStatusSetRequest
...
def sync_detailed(
    *,
    ...
    Args:
        body (ClientStatusSetRequest | Unset): Set Client Status request.
        body (ClientStatusSetRequest | Unset): Set Client Status request.
        body (ClientStatusSetRequest | Unset): Set Client Status request.
        body (ClientStatusSetRequest | Unset): Set Client Status request.
