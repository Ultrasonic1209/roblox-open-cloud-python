...
from ...models.post_v1_collections_items_item_type_item_target_id_item_type import (
...
def _get_kwargs(
    item_type: PostV1CollectionsItemsItemTypeItemTargetIdItemType,
    item_target_id: int,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "openapi-id": "post_v1_collections_items_itemType_itemTargetId",
    }
