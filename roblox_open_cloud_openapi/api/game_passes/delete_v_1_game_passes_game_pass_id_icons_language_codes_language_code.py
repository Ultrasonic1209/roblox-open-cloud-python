...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        ...
        "openapi-id": "delete_v1_game-passes_gamePassId_icons_language-codes_languageCode",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/game-passes#gameinternationalization_delete_v1_game_passes__gamePassId__icons_language_codes__languageCode_"
)
def sync_detailed(
    game_pass_id: int,
    language_code: str,
