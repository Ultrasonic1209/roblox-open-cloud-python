...
from ...models.roblox_game_internationalization_api_update_game_pass_description_request import (
    RobloxGameInternationalizationApiUpdateGamePassDescriptionRequest,
)
from ...models.roblox_game_internationalization_api_update_game_pass_description_response import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: RobloxGameInternationalizationApiUpdateGamePassDescriptionRequest
    | RobloxGameInternationalizationApiUpdateGamePassDescriptionRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "patch_v1_game-passes_gamePassId_description_language-codes_languageCode",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/game-passes#gameinternationalization_patch_v1_game_passes__gamePassId__description_language_codes__languageCode_"
)
def sync_detailed(
    game_pass_id: int,
    language_code: str,
    *,
    ...
    Args:
        game_pass_id (int):
        language_code (str):
        body (RobloxGameInternationalizationApiUpdateGamePassDescriptionRequest): A request model
            for updating game pass description
        body (RobloxGameInternationalizationApiUpdateGamePassDescriptionRequest): A request model
            for updating game pass description
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | RobloxGameInternationalizationApiUpdateGamePassDescriptionResponse
    """
