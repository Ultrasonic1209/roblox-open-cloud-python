...
from ...models.post_legacy_game_internationalization_v1_game_passes_game_pass_id_icons_language_codes_language_code_body import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: PostLegacyGameInternationalizationV1GamePassesGamePassIdIconsLanguageCodesLanguageCodeBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/legacy-game-internationalization/v1/game-passes/{game_pass_id}/icons/language-codes/{language_code}".format(
        ...
        "extensions": {
            ...
            "openapi-id": "post_legacy-game-internationalization_v1_game-passes_gamePassId_icons_language-codes_languageCode",
        },
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        game_pass_id (int):
        language_code (str):
        body (PostLegacyGameInternationalizationV1GamePassesGamePassIdIconsLanguageCodesLanguageCo
            deBody | Unset):
