...
from ...models.post_v1_game_passes_game_pass_id_icons_language_codes_language_code_body import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: PostV1GamePassesGamePassIdIconsLanguageCodesLanguageCodeBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://gameinternationalization.roblox.com/v1/game-passes/{game_pass_id}/icons/language-codes/{language_code}".format(
        ...
        "openapi-id": "post_v1_game-passes_gamePassId_icons_language-codes_languageCode",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/game-passes#gameinternationalization_post_v1_game_passes__gamePassId__icons_language_codes__languageCode_"
)
def sync_detailed(
    game_pass_id: int,
    language_code: str,
    *,
    ...
    Args:
        game_pass_id (int):
        language_code (str):
        body (PostV1GamePassesGamePassIdIconsLanguageCodesLanguageCodeBody | Unset):
