...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/game-passes#gameinternationalization_delete_v1_game_passes__gamePassId__name_description_language_codes__languageCode_"
)
def sync_detailed(
    game_pass_id: int,
    language_code: str,
