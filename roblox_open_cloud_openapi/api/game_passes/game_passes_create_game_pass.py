...
from ...models.game_passes_create_game_pass_body import GamePassesCreateGamePassBody
...
def _get_kwargs(
    universe_id: int,
    *,
    body: GamePassesCreateGamePassBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        universe_id (int):
        body (GamePassesCreateGamePassBody | Unset):
