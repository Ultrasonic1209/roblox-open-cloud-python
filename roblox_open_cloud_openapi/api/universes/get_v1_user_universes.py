...
from ...models.get_v1_user_universes_limit import GetV1UserUniversesLimit
from ...models.get_v1_user_universes_sort_order import GetV1UserUniversesSortOrder
...
def _get_kwargs(
    *,
    ...
    limit: GetV1UserUniversesLimit | Unset = GetV1UserUniversesLimit.VALUE_10,
    cursor: str | Unset = UNSET,
    sort_order: GetV1UserUniversesSortOrder | Unset = GetV1UserUniversesSortOrder.ASC,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        limit (GetV1UserUniversesLimit | Unset):  Default: GetV1UserUniversesLimit.VALUE_10.
        cursor (str | Unset):
        sort_order (GetV1UserUniversesSortOrder | Unset):  Default:
            GetV1UserUniversesSortOrder.ASC.
