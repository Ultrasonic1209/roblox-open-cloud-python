...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/universes/{universe_id}/activate".format(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/universes#develop_post_v1_universes__universeId__activate"
)
def sync_detailed(
    universe_id: int,
    *,
