...
from ...models.roblox_account_information_api_models_description_request import (
...
def _get_kwargs(
    *,
    body: RobloxAccountInformationApiModelsDescriptionRequest
    | RobloxAccountInformationApiModelsDescriptionRequest
    | Unset = UNSET,
) -> dict[str, Any]:
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/accounts#accountinformation_post_v1_description"
)
def sync_detailed(
    *,
    ...
    Args:
        body (RobloxAccountInformationApiModelsDescriptionRequest): The description request
        body (RobloxAccountInformationApiModelsDescriptionRequest): The description request
