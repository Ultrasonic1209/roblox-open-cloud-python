...
from ...models.roblox_two_step_verification_api_clear_recovery_codes_request import (
...
def _get_kwargs(
    user_id: int,
    *,
    body: RobloxTwoStepVerificationApiClearRecoveryCodesRequest
    | RobloxTwoStepVerificationApiClearRecoveryCodesRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/users/{user_id}/recovery-codes/clear".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (int):
        body (RobloxTwoStepVerificationApiClearRecoveryCodesRequest): Request information needed
            to clear existing recovery codes.
        body (RobloxTwoStepVerificationApiClearRecoveryCodesRequest): Request information needed
            to clear existing recovery codes.
