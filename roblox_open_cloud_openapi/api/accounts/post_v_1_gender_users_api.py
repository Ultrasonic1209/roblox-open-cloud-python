...
from ...models.roblox_users_api_gender_request import RobloxUsersApiGenderRequest
...
def _get_kwargs(
    *,
    body: RobloxUsersApiGenderRequest | RobloxUsersApiGenderRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/gender#UsersApi",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (RobloxUsersApiGenderRequest): The gender request
        body (RobloxUsersApiGenderRequest): The gender request
