...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://auth.roblox.com/v1/signup",
        "extensions": {
            "openapi-extensions": {
                ...
                "x-roblox-recommended-alternatives": [
                    {
                        ...
                        "httpMethod": "POST",
                        "documentationUrl": "https://create.roblox.com/docs/cloud/reference/features/accounts#auth_post_v2_signup",
                    }
                ],
            },
            "openapi-id": "post_v1_signup",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/accounts#auth_post_v1_signup"
)
def sync_detailed(
    *,
