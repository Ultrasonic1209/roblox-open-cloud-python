...
from ...models.roblox_authentication_api_models_username_change_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsUsernameChangeRequest
    | RobloxAuthenticationApiModelsUsernameChangeRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://auth.roblox.com/v1/username",
        "openapi-extensions": {"x-roblox-engine-usability": {"apiKeyWithHttpService": False}},
        "openapi-id": "post_v1_username",
    }

    if isinstance(body, RobloxAuthenticationApiModelsUsernameChangeRequest):
