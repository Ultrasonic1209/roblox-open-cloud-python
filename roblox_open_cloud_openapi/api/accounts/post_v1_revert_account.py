...
from ...models.roblox_authentication_api_models_revert_account_submit_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsRevertAccountSubmitRequest
    | RobloxAuthenticationApiModelsRevertAccountSubmitRequest
    | Unset = UNSET,
) -> dict[str, Any]:
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/accounts#auth_post_v1_revert_account"
)
def sync_detailed(
    *,
