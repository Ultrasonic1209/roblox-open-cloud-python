        ...
        "extensions": {
            "openapi-extensions": {
                ...
                "x-roblox-recommended-alternatives": [
                    {
                        "url": "https://auth.roblox.com/v3/logout",
                        "httpMethod": "POST",
                        "documentationUrl": "https://create.roblox.com/docs/cloud/reference/features/accounts#auth_post_v3_logout",
                    }
                ],
            },
            "openapi-id": "post_v1_logout",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/accounts#auth_post_v1_logout"
)
def sync_detailed(
    *,
