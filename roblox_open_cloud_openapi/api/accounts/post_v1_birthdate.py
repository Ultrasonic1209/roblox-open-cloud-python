...
from ...models.roblox_users_api_birthdate_request import RobloxUsersApiBirthdateRequest
...
def _get_kwargs(
    *,
    body: RobloxUsersApiBirthdateRequest | RobloxUsersApiBirthdateRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (RobloxUsersApiBirthdateRequest): The birthdate request
        body (RobloxUsersApiBirthdateRequest): The birthdate request
