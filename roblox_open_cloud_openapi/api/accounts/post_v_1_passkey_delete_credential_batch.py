...
from ...models.roblox_authentication_api_models_request_delete_passkeys_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsRequestDeletePasskeysRequest
    | RobloxAuthenticationApiModelsRequestDeletePasskeysRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://auth.roblox.com/v1/passkey/DeleteCredentialBatch",
        "openapi-extensions": {"x-roblox-engine-usability": {"apiKeyWithHttpService": False}},
        "openapi-id": "post_v1_passkey_DeleteCredentialBatch",
    }

    if isinstance(body, RobloxAuthenticationApiModelsRequestDeletePasskeysRequest):
