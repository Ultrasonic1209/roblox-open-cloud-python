...
from ...models.roblox_authentication_api_models_request_finish_passkey_registration_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsRequestFinishPasskeyRegistrationRequest
    | RobloxAuthenticationApiModelsRequestFinishPasskeyRegistrationRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://auth.roblox.com/v1/passkey/FinishRegistration",
        "extensions": {
            "openapi-extensions": {"x-roblox-engine-usability": {"apiKeyWithHttpService": False}},
            "openapi-id": "post_v1_passkey_FinishRegistration",
        },
    }

    if isinstance(body, RobloxAuthenticationApiModelsRequestFinishPasskeyRegistrationRequest):
