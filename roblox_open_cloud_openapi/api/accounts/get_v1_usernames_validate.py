...
from ...models.get_v1_usernames_validate_context import GetV1UsernamesValidateContext
...
def _get_kwargs(
    *,
    ...
    context: GetV1UsernamesValidateContext,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "openapi-id": "get_v1_usernames_validate",
    }
