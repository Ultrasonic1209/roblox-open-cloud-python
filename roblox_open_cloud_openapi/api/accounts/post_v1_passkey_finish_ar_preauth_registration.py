...
from ...models.roblox_authentication_api_models_request_finish_ar_pre_auth_passkey_registration_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsRequestFinishARPreAuthPasskeyRegistrationRequest
    | RobloxAuthenticationApiModelsRequestFinishARPreAuthPasskeyRegistrationRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://auth.roblox.com/v1/passkey/finish-ar-preauth-registration",
        "openapi-extensions": {"x-roblox-engine-usability": {"apiKeyWithHttpService": False}},
        "openapi-id": "post_v1_passkey_finish-ar-preauth-registration",
    }

    if isinstance(body, RobloxAuthenticationApiModelsRequestFinishARPreAuthPasskeyRegistrationRequest):
