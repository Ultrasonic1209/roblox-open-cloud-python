                ...
                "x-roblox-recommended-alternatives": [
                    {
                        ...
                        "httpMethod": "GET",
                        "documentationUrl": "https://create.roblox.com/docs/cloud/reference/features/accounts#auth_get_v2_auth_metadata",
                    }
                ],
            },
            "openapi-id": "get_v1_auth_metadata",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/accounts#auth_get_v1_auth_metadata"
)
def sync_detailed(
    *,
