...
from ...models.roblox_authentication_api_models_social_authentication_disconnect_request import (
...
def _get_kwargs(
    provider: str,
    *,
    body: RobloxAuthenticationApiModelsSocialAuthenticationDisconnectRequest
    | RobloxAuthenticationApiModelsSocialAuthenticationDisconnectRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/social/{provider}/disconnect".format(
