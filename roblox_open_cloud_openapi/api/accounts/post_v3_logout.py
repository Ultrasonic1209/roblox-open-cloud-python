...
from ...models.roblox_authentication_api_models_request_logout_v3_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsRequestLogoutV3Request
    | RobloxAuthenticationApiModelsRequestLogoutV3Request
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "post_v3_logout",
        },
    }

    if isinstance(body, RobloxAuthenticationApiModelsRequestLogoutV3Request):
