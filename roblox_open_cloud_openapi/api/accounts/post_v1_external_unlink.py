...
from ...models.roblox_authentication_api_models_request_external_unlink_request import (
...
def _get_kwargs(
    *,
    body: RobloxAuthenticationApiModelsRequestExternalUnlinkRequest
    | RobloxAuthenticationApiModelsRequestExternalUnlinkRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://auth.roblox.com/v1/external/unlink",
        "openapi-extensions": {"x-roblox-engine-usability": {"apiKeyWithHttpService": False}},
        "openapi-id": "post_v1_external_unlink",
    }

    if isinstance(body, RobloxAuthenticationApiModelsRequestExternalUnlinkRequest):
