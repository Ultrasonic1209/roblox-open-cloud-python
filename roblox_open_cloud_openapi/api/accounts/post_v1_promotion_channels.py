...
from ...models.roblox_account_information_api_models_promotion_channels_request import (
...
def _get_kwargs(
    *,
    body: RobloxAccountInformationApiModelsPromotionChannelsRequest
    | RobloxAccountInformationApiModelsPromotionChannelsRequest
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (RobloxAccountInformationApiModelsPromotionChannelsRequest): The promotion channels
            request
        body (RobloxAccountInformationApiModelsPromotionChannelsRequest): The promotion channels
            request
