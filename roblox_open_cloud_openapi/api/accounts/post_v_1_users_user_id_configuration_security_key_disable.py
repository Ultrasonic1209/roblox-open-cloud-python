...
from ...models.roblox_two_step_verification_api_disable_security_key_request import (
...
def _get_kwargs(
    user_id: int,
    *,
    body: RobloxTwoStepVerificationApiDisableSecurityKeyRequest
    | RobloxTwoStepVerificationApiDisableSecurityKeyRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/users/{user_id}/configuration/security-key/disable".format(
