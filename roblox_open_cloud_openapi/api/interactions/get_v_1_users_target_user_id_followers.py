...
from ...models.get_v1_users_target_user_id_followers_limit import GetV1UsersTargetUserIdFollowersLimit
from ...models.get_v1_users_target_user_id_followers_sort_order import GetV1UsersTargetUserIdFollowersSortOrder
...
def _get_kwargs(
    target_user_id: int,
    *,
    limit: GetV1UsersTargetUserIdFollowersLimit | Unset = GetV1UsersTargetUserIdFollowersLimit.VALUE_10,
    cursor: str | Unset = UNSET,
    sort_order: GetV1UsersTargetUserIdFollowersSortOrder | Unset = GetV1UsersTargetUserIdFollowersSortOrder.ASC,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "https://friends.roblox.com/v1/users/{target_user_id}/followers".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        target_user_id (int):
        limit (GetV1UsersTargetUserIdFollowersLimit | Unset):  Default:
            GetV1UsersTargetUserIdFollowersLimit.VALUE_10.
        cursor (str | Unset):
        sort_order (GetV1UsersTargetUserIdFollowersSortOrder | Unset):  Default:
            GetV1UsersTargetUserIdFollowersSortOrder.ASC.
