...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/legacy-followings/v1/users/{user_id}/universes/{universe_id}/status".format(
        ...
        "extensions": {
            ...
            "openapi-id": "get_legacy-followings_v1_users_userId_universes_universeId_status",
        },
    }
