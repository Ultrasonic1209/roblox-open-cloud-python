...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "post_v1_users_userId_universes_universeId",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/interactions#followings_post_v1_users__userId__universes__universeId_"
)
def sync_detailed(
    user_id: int,
    universe_id: int,
