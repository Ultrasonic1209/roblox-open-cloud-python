...
from ...models.roblox_games_api_models_request_game_favorites_request import (
...
def _get_kwargs(
    universe_id: int,
    *,
    body: RobloxGamesApiModelsRequestGameFavoritesRequest
    | RobloxGamesApiModelsRequestGameFavoritesRequest
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, RobloxGamesApiModelsRequestGameFavoritesRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        universe_id (int):
        body (RobloxGamesApiModelsRequestGameFavoritesRequest): Game favorite request model.
        body (RobloxGamesApiModelsRequestGameFavoritesRequest): Game favorite request model.
