...
def _get_kwargs(
    ...
    keyword_id: str,
    *,
    body: RobloxGroupsApiUpdateBlockedKeywordRequest | RobloxGroupsApiUpdateBlockedKeywordRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        group_id (int):
        keyword_id (str):
        body (RobloxGroupsApiUpdateBlockedKeywordRequest):
        body (RobloxGroupsApiUpdateBlockedKeywordRequest):
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | RobloxGroupsClientBlockedKeywordModel
    """
