...
from ...models.list_user_restriction_logs_response import ListUserRestrictionLogsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/cloud/v2/universes/{universe_id}/user-restrictions:listLogs".format(
        ...
        "openapi-id": "Cloud_ListUserRestrictionLogs",
    }
...
) -> ListUserRestrictionLogsResponse | None:
    if response.status_code == 200:
        response_200 = ListUserRestrictionLogsResponse.from_dict(response.json())
