...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/analytics-query-api/v1/universes/{universe_id}/operations/metrics/{operation_id}".format(
        ...
        "extensions": {
            "openapi-extensions": {
                ...
                "x-roblox-rate-limits": {
                    "perApiKeyOwner": {"period": "MINUTE", "maxInPeriod": 3000},
                    "perOauth2Authorization": {"period": "MINUTE", "maxInPeriod": 3000},
                },
                "x-roblox-scopes": [{"name": "universe.analytics:read", "targetResourceSpecifier": "universes"}],
                "x-roblox-engine-usability": {"apiKeyWithHttpService": False},
            },
            "openapi-id": "get_analytics-query-api_v1_universes_universeId_operations_metrics_operationId",
        },
    }
