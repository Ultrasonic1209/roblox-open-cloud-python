...
from ...models.roblox_ad_configuration_api_create_sponsored_game_v2_request import (
...
def _get_kwargs(
    *,
    body: RobloxAdConfigurationApiCreateSponsoredGameV2Request
    | RobloxAdConfigurationApiCreateSponsoredGameV2Request
    | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://adconfiguration.roblox.com/v2/sponsored-games/create",
        "openapi-extensions": {"x-roblox-engine-usability": {"apiKeyWithHttpService": False}},
        "openapi-id": "post_v2_sponsored-games_create",
    }

    if isinstance(body, RobloxAdConfigurationApiCreateSponsoredGameV2Request):
...
def sync_detailed(
    *,
    ...
    Args:
        body (RobloxAdConfigurationApiCreateSponsoredGameV2Request): A request model for creating
            a sponsored game
        body (RobloxAdConfigurationApiCreateSponsoredGameV2Request): A request model for creating
            a sponsored game
