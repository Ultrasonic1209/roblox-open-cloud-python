...
from ...models.post_v1_badges_badge_id_icons_language_codes_language_code_body import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: PostV1BadgesBadgeIdIconsLanguageCodesLanguageCodeBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://gameinternationalization.roblox.com/v1/badges/{badge_id}/icons/language-codes/{language_code}".format(
        ...
        "extensions": {
            ...
            "openapi-id": "post_v1_badges_badgeId_icons_language-codes_languageCode",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/badges#gameinternationalization_post_v1_badges__badgeId__icons_language_codes__languageCode_"
)
def sync_detailed(
    badge_id: int,
    language_code: str,
    *,
    ...
    Args:
        badge_id (int):
        language_code (str):
        body (PostV1BadgesBadgeIdIconsLanguageCodesLanguageCodeBody | Unset):
