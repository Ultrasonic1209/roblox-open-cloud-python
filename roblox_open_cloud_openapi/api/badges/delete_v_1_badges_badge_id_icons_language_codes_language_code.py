...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        ...
        "openapi-id": "delete_v1_badges_badgeId_icons_language-codes_languageCode",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/badges#gameinternationalization_delete_v1_badges__badgeId__icons_language_codes__languageCode_"
)
def sync_detailed(
    badge_id: int,
    language_code: str,
