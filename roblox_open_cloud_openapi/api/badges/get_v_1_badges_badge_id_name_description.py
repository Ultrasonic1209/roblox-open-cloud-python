...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/badges/{badge_id}/name-description".format(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/badges#gameinternationalization_get_v1_badges__badgeId__name_description"
)
def sync_detailed(
    badge_id: int,
    *,
