...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/legacy-game-internationalization/v1/badges/{badge_id}/name/language-codes/{language_code}".format(
        ...
        "openapi-id": "patch_legacy-game-internationalization_v1_badges_badgeId_name_language-codes_languageCode",
    }
