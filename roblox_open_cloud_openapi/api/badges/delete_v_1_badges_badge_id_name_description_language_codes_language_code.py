...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "https://gameinternationalization.roblox.com/v1/badges/{badge_id}/name-description/language-codes/{language_code}".format(
        ...
        "openapi-id": "delete_v1_badges_badgeId_name-description_language-codes_languageCode",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/badges#gameinternationalization_delete_v1_badges__badgeId__name_description_language_codes__languageCode_"
)
def sync_detailed(
    badge_id: int,
    language_code: str,
