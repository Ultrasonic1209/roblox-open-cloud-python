...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/legacy-game-internationalization/v1/badges/{badge_id}/name-description".format(
        ...
        "extensions": {
            ...
            "openapi-id": "get_legacy-game-internationalization_v1_badges_badgeId_name-description",
        },
    }
