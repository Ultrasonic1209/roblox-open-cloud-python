...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/legacy-game-internationalization/v1/badges/{badge_id}/name-description/language-codes/{language_code}".format(
        ...
        "extensions": {
            ...
            "openapi-id": "delete_legacy-game-internationalization_v1_badges_badgeId_name-description_language-codes_languageCode",
        },
    }
