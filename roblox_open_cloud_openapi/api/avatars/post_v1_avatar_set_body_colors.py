...
def _get_kwargs(
    *,
    body: RobloxApiAvatarModelsBodyColorsModel | RobloxApiAvatarModelsBodyColorsModel | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (RobloxApiAvatarModelsBodyColorsModel): A model container BrickColor ids for each
            body part.
        body (RobloxApiAvatarModelsBodyColorsModel): A model container BrickColor ids for each
            body part.
