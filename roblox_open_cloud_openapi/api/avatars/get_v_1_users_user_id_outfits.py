...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "https://avatar.roblox.com/v1/users/{user_id}/outfits".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
    ...
    if response.status_code == 200:
        response_200 = RobloxApiAvatarModelsAvatarFilteredPageResponseRobloxApiAvatarModelsOutfitModel.from_dict(
            response.json()
        )
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | RobloxApiAvatarModelsAvatarFilteredPageResponseRobloxApiAvatarModelsOutfitModel
    """
