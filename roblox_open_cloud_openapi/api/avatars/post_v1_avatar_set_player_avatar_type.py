...
from ...models.roblox_api_avatar_models_player_avatar_type_model import RobloxApiAvatarModelsPlayerAvatarTypeModel
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: RobloxApiAvatarModelsPlayerAvatarTypeModel | RobloxApiAvatarModelsPlayerAvatarTypeModel | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    """Sets the authenticated user's player avatar type (e.g. R6 or R15).
     ...
     This is the avatar type chosen on the Avatar page. Some games can override this and force your
    character to be R6 or R15.

    Args:
        roblox_place_id (int | Unset):
        body (RobloxApiAvatarModelsPlayerAvatarTypeModel): A model that contains a
            playerAvatarType
        body (RobloxApiAvatarModelsPlayerAvatarTypeModel): A model that contains a
            playerAvatarType
