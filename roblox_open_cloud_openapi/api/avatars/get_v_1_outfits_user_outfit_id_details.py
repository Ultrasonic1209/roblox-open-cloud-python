...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "https://avatar.roblox.com/v1/outfits/{user_outfit_id}/details".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
    ...
    if response.status_code == 200:
        response_200 = RobloxApiAvatarModelsOutfitDetailsModel.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | RobloxApiAvatarModelsOutfitDetailsModel
    """
