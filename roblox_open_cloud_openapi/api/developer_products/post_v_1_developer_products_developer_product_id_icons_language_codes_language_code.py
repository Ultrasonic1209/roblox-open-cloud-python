...
from ...models.post_v1_developer_products_developer_product_id_icons_language_codes_language_code_body import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: PostV1DeveloperProductsDeveloperProductIdIconsLanguageCodesLanguageCodeBody | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "post_v1_developer-products_developerProductId_icons_language-codes_languageCode",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/developer-products#gameinternationalization_post_v1_developer_products__developerProductId__icons_language_codes__languageCode_"
)
def sync_detailed(
    developer_product_id: int,
    language_code: str,
    *,
    ...
    Args:
        developer_product_id (int):
        language_code (str):
        body (PostV1DeveloperProductsDeveloperProductIdIconsLanguageCodesLanguageCodeBody |
            Unset):
