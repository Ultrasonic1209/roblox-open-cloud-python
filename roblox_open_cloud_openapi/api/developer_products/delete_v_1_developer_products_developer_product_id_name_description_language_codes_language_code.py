...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        ...
        "openapi-id": "delete_v1_developer-products_developerProductId_name-description_language-codes_languageCode",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/developer-products#gameinternationalization_delete_v1_developer_products__developerProductId__name_description_language_codes__languageCode_"
)
def sync_detailed(
    developer_product_id: int,
    language_code: str,
