...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "https://gameinternationalization.roblox.com/v1/developer-products/{developer_product_id}/name/language-codes/{language_code}".format(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/developer-products#gameinternationalization_patch_v1_developer_products__developerProductId__name_language_codes__languageCode_"
)
def sync_detailed(
    developer_product_id: int,
    language_code: str,
