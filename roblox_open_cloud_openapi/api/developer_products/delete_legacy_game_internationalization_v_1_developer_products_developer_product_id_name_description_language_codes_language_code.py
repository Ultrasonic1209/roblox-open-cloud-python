...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/legacy-game-internationalization/v1/developer-products/{developer_product_id}/name-description/language-codes/{language_code}".format(
        ...
        "openapi-id": "delete_legacy-game-internationalization_v1_developer-products_developerProductId_name-description_language-codes_languageCode",
    }
