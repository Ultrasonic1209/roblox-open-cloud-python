...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/cloud/v2/universes/{universe_id}/data-stores/{data_store_id}/scopes/{scope_id}/entries/{entry_id}:listRevisions".format(
        ...
        "extensions": {
            ...
            "openapi-id": "Cloud_ListDataStoreEntryRevisions__Using_Universes_DataStores_Scopes",
        },
    }
