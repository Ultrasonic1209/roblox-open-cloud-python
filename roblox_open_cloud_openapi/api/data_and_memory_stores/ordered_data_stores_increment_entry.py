...
from ...models.increment_entry_request import IncrementEntryRequest
...
def _get_kwargs(
    ...
    entry: str,
    *,
    body: IncrementEntryRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/ordered-data-stores/v1/universes/{universe_id}/orderedDataStores/{ordered_data_store}/scopes/{scope}/entries/{entry}:increment".format(
        ...
        "extensions": {
            ...
            "openapi-id": "OrderedDataStores_IncrementEntry",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/storage#OrderedDataStores_IncrementEntry"
)
def sync_detailed(
    universe_id: str,
    ordered_data_store: str,
    ...
    *,
    ...
    Known issue: Entry values can increment past the valid range and this may persist in the backend.
    Returned values will clamp to the valid range.
    ...
    Args:
        ...
        scope (str):
        entry (str):
        body (IncrementEntryRequest): Increments entry value.
