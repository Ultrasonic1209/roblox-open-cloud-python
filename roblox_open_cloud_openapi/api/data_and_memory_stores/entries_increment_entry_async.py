    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "Entries_IncrementEntryAsync",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/storage#Entries_IncrementEntryAsync"
)
def sync_detailed(
    universe_id: int,
    *,
