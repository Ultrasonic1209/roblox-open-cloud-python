...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        ...
        "extensions": {
            ...
            "openapi-id": "OrderedDataStores_DeleteEntry",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/storage#OrderedDataStores_DeleteEntry"
)
def sync_detailed(
    universe_id: str,
    ordered_data_store: str,
    ...
    *,
    ...
    """Deletes the specified entry. Unlike standard data stores, which mark entries for deletion, ordered
    data store entries are deleted immediately.
