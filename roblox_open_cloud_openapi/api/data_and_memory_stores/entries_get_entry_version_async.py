...
from ...models.entries_get_entry_version_async_response_200 import EntriesGetEntryVersionAsyncResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    json_version_id: None | str | Unset
    if isinstance(version_id, Unset):
        json_version_id = UNSET
    else:
        json_version_id = version_id
    params["versionId"] = json_version_id
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/datastores/v1/universes/{universe_id}/standard-datastores/datastore/entries/entry/versions/version".format(
        ...
        "extensions": {
            "openapi-extensions": {
                ...
                "x-roblox-scopes": [{"name": "universe-datastores.versions:read"}],
            ...
            "openapi-id": "Entries_GetEntryVersionAsync",
        },
    }
...
) -> EntriesGetEntryVersionAsyncResponse200 | None:
    if response.status_code == 200:
        response_200 = EntriesGetEntryVersionAsyncResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx2.Response
) -> Response[EntriesGetEntryVersionAsyncResponse200]:
    return Response(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/storage#Entries_GetEntryVersionAsync"
)
def sync_detailed(
    universe_id: int,
    *,
