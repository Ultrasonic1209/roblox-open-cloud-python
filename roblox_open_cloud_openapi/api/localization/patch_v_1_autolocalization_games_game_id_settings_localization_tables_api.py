...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "https://localizationtables.roblox.com/v1/autolocalization/games/{game_id}/settings#LocalizationTablesApi".format(
        ...
        "openapi-id": "patch_v1_autolocalization_games_gameId_settings#LocalizationTablesApi",
    }
