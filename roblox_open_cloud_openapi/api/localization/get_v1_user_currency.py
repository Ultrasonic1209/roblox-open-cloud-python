...
from ...models.roblox_web_responses_economy_currency_response import RobloxWebResponsesEconomyCurrencyResponse
...
def _get_kwargs() -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "openapi-id": "get_v1_user_currency",
    }
...
def sync(
    *,
    ...
    Returns:
        Any | RobloxWebResponsesEconomyCurrencyResponse
    """
