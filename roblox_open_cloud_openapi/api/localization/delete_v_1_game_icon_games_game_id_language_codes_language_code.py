...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/localization#gameinternationalization_delete_v1_game_icon_games__gameId__language_codes__languageCode_"
)
def sync_detailed(
    game_id: int,
    language_code: str,
