...
from ...models.roblox_locale_api_set_supported_locale_for_user_request import (
...
def _get_kwargs(
    *,
    body: RobloxLocaleApiSetSupportedLocaleForUserRequest
    | RobloxLocaleApiSetSupportedLocaleForUserRequest
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (RobloxLocaleApiSetSupportedLocaleForUserRequest): Request entity to set Supported
            Locale for user
        body (RobloxLocaleApiSetSupportedLocaleForUserRequest): Request entity to set Supported
            Locale for user
