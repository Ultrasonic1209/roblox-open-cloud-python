...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/localization-table/tables/{table_id}".format(
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/localization#localizationtables_patch_v1_localization_table_tables__tableId_"
)
def sync_detailed(
    table_id: UUID,
    *,
