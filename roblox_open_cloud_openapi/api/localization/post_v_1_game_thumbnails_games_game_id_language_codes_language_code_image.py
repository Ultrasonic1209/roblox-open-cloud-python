...
from ...models.post_v1_game_thumbnails_games_game_id_language_codes_language_code_image_body import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: PostV1GameThumbnailsGamesGameIdLanguageCodesLanguageCodeImageBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://gameinternationalization.roblox.com/v1/game-thumbnails/games/{game_id}/language-codes/{language_code}/image".format(
        ...
        "openapi-id": "post_v1_game-thumbnails_games_gameId_language-codes_languageCode_image",
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/localization#gameinternationalization_post_v1_game_thumbnails_games__gameId__language_codes__languageCode__image"
)
def sync_detailed(
    game_id: int,
    language_code: str,
    *,
    ...
    Args:
        game_id (int):
        language_code (str):
        body (PostV1GameThumbnailsGamesGameIdLanguageCodesLanguageCodeImageBody | Unset):
