...
from ...models.post_v1_game_icon_games_game_id_language_codes_language_code_body import (
...
def _get_kwargs(
    ...
    language_code: str,
    *,
    body: PostV1GameIconGamesGameIdLanguageCodesLanguageCodeBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "https://gameinternationalization.roblox.com/v1/game-icon/games/{game_id}/language-codes/{language_code}".format(
        ...
        "extensions": {
            ...
            "openapi-id": "post_v1_game-icon_games_gameId_language-codes_languageCode",
        },
    }
...
@deprecated(
    "Roblox has deprecated this endpoint. See documentation: https://create.roblox.com/docs/cloud/reference/features/localization#gameinternationalization_post_v1_game_icon_games__gameId__language_codes__languageCode_"
)
def sync_detailed(
    game_id: int,
    language_code: str,
    *,
    ...
    Args:
        game_id (int):
        language_code (str):
        body (PostV1GameIconGamesGameIdLanguageCodesLanguageCodeBody | Unset):
