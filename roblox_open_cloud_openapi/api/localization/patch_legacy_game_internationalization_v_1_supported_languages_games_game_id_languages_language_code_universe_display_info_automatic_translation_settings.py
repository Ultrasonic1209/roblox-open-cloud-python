...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/legacy-game-internationalization/v1/supported-languages/games/{game_id}/languages/{language_code}/universe-display-info-automatic-translation-settings".format(
        ...
        "extensions": {
            ...
            "openapi-id": "patch_legacy-game-internationalization_v1_supported-languages_games_gameId_languages_languageCode_universe-display-info-automatic-translation-settings",
        },
    }
