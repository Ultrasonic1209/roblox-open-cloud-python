...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/legacy-game-internationalization/v1/game-thumbnails/games/{game_id}/language-codes/{language_code}/alt-text".format(
        ...
        "extensions": {
            ...
            "openapi-id": "post_legacy-game-internationalization_v1_game-thumbnails_games_gameId_language-codes_languageCode_alt-text",
        },
    }
