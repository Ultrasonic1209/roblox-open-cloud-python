...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/legacy-game-internationalization/v1/game-thumbnails/games/{game_id}/language-codes/{language_code}/images/{image_id}".format(
        ...
        "openapi-id": "delete_legacy-game-internationalization_v1_game-thumbnails_games_gameId_language-codes_languageCode_images_imageId",
    }
