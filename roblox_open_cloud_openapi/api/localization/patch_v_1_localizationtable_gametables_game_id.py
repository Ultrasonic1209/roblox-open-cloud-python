...
from ...models.roblox_game_internationalization_api_associate_localization_tables_to_game_request import (
...
def _get_kwargs(
    game_id: int,
    *,
    body: RobloxGameInternationalizationApiAssociateLocalizationTablesToGameRequest
    | RobloxGameInternationalizationApiAssociateLocalizationTablesToGameRequest
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | RobloxGameInternationalizationApiAssociateLocalizationTablesToGameResponse
    """
