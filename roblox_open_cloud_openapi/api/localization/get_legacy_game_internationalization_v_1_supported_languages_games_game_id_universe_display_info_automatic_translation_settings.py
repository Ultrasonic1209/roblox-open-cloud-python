...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/legacy-game-internationalization/v1/supported-languages/games/{game_id}/universe-display-info-automatic-translation-settings".format(
        ...
        "openapi-id": "get_legacy-game-internationalization_v1_supported-languages_games_gameId_universe-display-info-automatic-translation-settings",
    }
