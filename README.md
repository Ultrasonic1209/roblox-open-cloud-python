# roblox-open-cloud-openapi
A client library for accessing Roblox API

## Usage
First, create a client:

```python
from roblox_open_cloud_openapi import Client
...
```python
from roblox_open_cloud_openapi import AuthenticatedClient
...
```python
from roblox_open_cloud_openapi.models import MyDataModel
from roblox_open_cloud_openapi.api.my_tag import get_my_data_model
from roblox_open_cloud_openapi.types import Response
...
1. Any endpoint which did not have a tag will be in `roblox_open_cloud_openapi.api.default`
